          ...
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return Column(
              children: [
                ...
                //   itemCount: min(gameHistoryList.length, 5),
                //   itemBuilder: (context, index) {
                //     Map<String, dynamic> data = gameHistoryList[index];
                //     Map<String, dynamic> gameData = data['gameData'];
                //     Map<String, dynamic> userData = data['otherPlayer'];
                ...
                //     // Display relevant information from the game and user data
                //     return Container(
                //       padding: EdgeInsets.all(5),
                //       margin: EdgeInsets.all(5),
                //       decoration: AppConstants.gamePlayingActiveDecoraton,
                ...
                //             Container(
                //               width: 100,
                //               child: Text(winOrLose ? "Won" : "Lost"),
                //             ),
                //             // Text(userData['name'] ?? ""),
                //             // Text(gameData['winner'] == 1 ? "Won" : "Lost"),
                //           ]),
                //     );
                //   },
                // )),
